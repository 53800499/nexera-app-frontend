...
export const MAIN_NAV_CONFIG: NavItemConfig[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Écritures Comptables OD", path: "/rh/comptabilite" },
  ...
  /* {
    ...
    iconKey: "file",
    path: "/fiscalite",
    canAccess: (p) => p.fiscalite,
    subItems: [
      { name: "Tableau de Bord", path: "/fiscalite" },
      { name: "Déclarations TVA", path: "/fiscalite/tva" },
      { name: "Impôt Sociétés (IS)", path: "/fiscalite/is" },
      { name: "Retenues AIB", path: "/fiscalite/aib" },
      { name: "Calendrier & Alertes", path: "/fiscalite/calendrier" },
      { name: "Autres Taxes & Patente", path: "/fiscalite/autres-taxes" },
      { name: "Liasse Fiscale", path: "/fiscalite/liasse-fiscale" },
      { name: "Export FEC (Arrêté 1085-C)", path: "/fiscalite/fec" },
      { name: "Contrôles & Contentieux", path: "/fiscalite/controles" },
      { name: "Veille & Référentiel", path: "/fiscalite/veille" },
    ],
  }, */
  {
    id: "relances",
