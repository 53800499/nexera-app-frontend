...
export function BrandResultIcon({ className }: IconProps) {
  return (
    <BlobBackground fillClass="fill-brand-50 dark:fill-brand-500/15">
      <svg
        className={cn("fill-brand-500 dark:fill-brand-400", className)}
        width="38"
        height="38"
        viewBox="0 0 38 38"
        fill="none"
...
export function ResultIcon({ variant }: { variant: ActionResultVariant }) {
  ...
  if (variant === "brand") return <BrandResultIcon />;
